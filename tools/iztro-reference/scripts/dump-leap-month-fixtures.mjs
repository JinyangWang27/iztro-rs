...
// to crates/iztro/fixtures/iztro/leap_month_by_lunar.json.
...
if (process.argv.includes("--write")) {
  writeFileSync(
    join(REPO_ROOT, "crates", "iztro", "fixtures", "iztro", "leap_month_by_lunar.json"),
    `${JSON.stringify(fixture, null, 2)}\n`
  );
  console.log("wrote crates/iztro/fixtures/iztro/leap_month_by_lunar.json");
} else {
