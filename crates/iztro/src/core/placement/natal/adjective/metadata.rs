...
use crate::core::model::star::{StarMetadata, StarName};
...
pub const fn adjective_star_metadata_table() -> &'static [StarMetadata] {
    crate::core::model::star::adjective_star_metadata_table()
}
...
pub fn adjective_star_metadata(star: StarName) -> &'static StarMetadata {
    crate::core::model::star::adjective_star_metadata(star)
}
...
pub fn try_adjective_star_metadata(star: StarName) -> Option<&'static StarMetadata> {
    crate::core::model::star::try_adjective_star_metadata(star)
}
