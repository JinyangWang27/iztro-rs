...
//! occupied — one by 文昌 and the other by 文曲, in either orientation. This rule
...
pub fn detect(
    ...
    let Some([(low_star, low_branch), (high_star, high_branch)]) =
        clamp_pair_matches(chart, anchor, StarName::WenChang, StarName::WenQu)
    else {
        return;
    };
    ...
    out.push(PatternDetection {
        ...
        involved_palaces,
        involved_stars: vec![StarName::WenChang, StarName::WenQu],
