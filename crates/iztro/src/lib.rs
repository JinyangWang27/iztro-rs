...
pub use core::{
    ...
    VISUAL_BRANCH_ORDER, YearlyMutagenLayerInput, adjective_star_metadata,
    adjective_star_metadata_table, birth_year_major_star_mutagen, birth_year_star_mutagen,
    build_age_horoscope_layer, build_age_period, build_decadal_frame,
    ...
    build_yearly_mutagen_layer, by_lunar, by_solar, calculate_life_body_palace_indices,
    five_element_bureau_from_life_palace, flow_star_name, known_star_metadata,
