...
use crate::placement::overlay::decadal::{DecadalMutagenLayerInput, build_decadal_mutagen_layer};
use crate::placement::overlay::flow::build_flow_star_layer;
...
pub struct DecadalHoroscopeInput {
    ...
    ///
    /// [`DecadalFrame::periods`]: crate::model::chart::DecadalFrame::periods
