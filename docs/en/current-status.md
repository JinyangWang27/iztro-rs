...
This document summarizes the current implemented surface after the recent `lunar-lite`, snapshot, renderer, and demo work.
...
- 大限 / 流年 / 流月 / 流日 / 流时 period derivation;
...
3. Add full horoscope assembly in small PRs: decadal frame first, then yearly, monthly, daily, and hourly derivation.
