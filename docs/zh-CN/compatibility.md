...
保持在 `FlowStarBase` 之外。流月和流日 layer 现在会附带 fixture-backed 的宫名布局；其他
...
decorative arrays（`yearlyDecStar`）、完整 horoscope 组装、流时 period 与宫名布局、
